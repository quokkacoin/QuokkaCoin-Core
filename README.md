...
|   `puppqkc`   | a CLI wizard that aids in creating a new Quokkachain network.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
As a developer, sooner rather than later you'll want to start interacting with `gqkc` and the
